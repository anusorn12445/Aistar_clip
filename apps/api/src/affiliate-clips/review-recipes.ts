...
export const REVIEW_RECIPES: Record<string, ReviewRecipe> = {
  'product/general': {
    key: 'product/general',
    label: 'สินค้าทั่วไป — 7 ช็อต (ปัญหา→แกะกล่อง→ผลลัพธ์)',
    sceneFlow: [
      { name: 'เล่าปัญหา (Problem)', note: 'hook — testimonial จริงใจ เล่าด้วยปากถึงปัญหาที่เจอจริง สีหน้าอ่านง่าย ยังไม่โชว์สินค้า ไม่ render สภาพแย่บนตัว' },
      { name: 'แกะกล่องพัสดุ (Unboxing)', note: 'เห็นแค่มือแกะกล่องพัสดุ ยังไม่เผยตัวสินค้า สร้างความคาดหวัง' },
      { name: 'เผยสินค้า (Reveal)', note: 'ยกสินค้าขึ้นโชว์ครั้งแรก ฉลากหันเข้ากล้องชัด สินค้าเป็นพระเอกเต็มเฟรม' },
      { name: 'สัมผัสสินค้า (Interaction)', note: 'จับ พลิกดูรายละเอียด สัมผัสเนื้อ/แพ็กเกจ — โคลสอัพมือกับสินค้า' },
      { name: 'สาธิตการใช้ (Demonstration)', note: 'ใช้งานจริงตามชนิดสินค้า แบบคนใช้จริง (ช็อตยาวสุด) ไม่ใช่โฆษณาแข็ง' },
      { name: 'ผลลัพธ์ (Result)', note: 'โชว์สภาพหลังใช้ที่ believable ไม่ CGI-perfect ไม่เคลมเกินจริง' },
      { name: 'ปิดการขาย (CTA)', note: 'ถือสินค้าชวนกดชัดเจน ไม่กำกวม' },
    ],
    promptEmphasis: [
  ...
  'product/beauty': {
    key: 'product/beauty',
    label: 'บิวตี้/สกินแคร์ — 7 ช็อต (ปัญหา→แกะกล่อง→ผลลัพธ์)',
    sceneFlow: [
      { name: 'เล่าปัญหาผิว (Problem)', note: 'hook — testimonial จริงใจ เล่าด้วยปากถึงปัญหาผิวที่เจอจริง ยังไม่โชว์สินค้า ไม่ render สภาพผิวแย่บนตัว' },
      { name: 'แกะกล่องพัสดุ (Unboxing)', note: 'เห็นแค่มือแกะกล่องพัสดุ ยังไม่เผยตัวสินค้า' },
      { name: 'เผยสินค้า (Reveal)', note: 'ยกสินค้าขึ้นโชว์ครั้งแรก แบรนด์/ฉลากหันกล้องชัด' },
      { name: 'เนื้อสัมผัส (Interaction)', note: 'texture close-up — บีบเนื้อครีม/เซรั่มบนหลังมือ โคลสอัพเนื้อจริง' },
      { name: 'วิธีใช้ (Demonstration)', note: 'ทา/ใช้จริงบนผิวตามขั้นตอน (ช็อตยาวสุด) แบบคนใช้จริง' },
      { name: 'ฟีลหลังใช้ (Result)', note: 'สภาพผิว/ความรู้สึกหลังใช้ที่ believable — ห้ามเคลมผลลัพธ์ทางการแพทย์' },
      { name: 'ปิดการขาย (CTA)', note: 'ถือสินค้าชวนกดชัดเจน' },
    ],
    promptEmphasis: [
  ...
  'product/toothpaste': {
    ...
    sceneFlow: [
      { name: 'เล่าปัญหาปาก (Problem)', note: 'hook ความไม่มั่นใจที่คนเจอจริง — กลิ่นปาก/คราบชา-กาแฟ/ไม่กล้ายิ้ม ท่าเอามือป้องปาก ยังไม่โชว์สินค้า' },
      { name: 'แกะกล่องพัสดุ (Unboxing)', note: 'เห็นแค่มือแกะกล่องพัสดุ ยังไม่เผยหลอด' },
      { name: 'เผยหลอด (Reveal)', note: 'ยกหลอดขึ้นโชว์ครั้งแรก ฉลาก+แถบสีหันกล้องชัด สินค้าเป็นพระเอก' },
      { name: 'บีบเนื้อยา (Interaction)', note: 'ซิกเนเจอร์ของหมวด: บีบเป็นแถบเรียบบนขนแปรง เห็นเนื้อ/แถบสีโคลสอัป' },
      { name: 'แปรงจริง (Demonstration)', note: 'แปรงฟันหน้าวนเบาๆ ฟองนิดเดียวดูสดชื่น (ช็อตยาวสุด) ไม่ใช่โฆษณาเวอร์' },
      { name: 'ยิ้มมั่นใจ (Result)', note: 'ยิ้มกว้างฟันดูสะอาด ลมหายใจสดชื่น — ห้ามเคลมผลทางการแพทย์/ฟันขาวขึ้นกี่เฉด' },
      { name: 'ปิดการขาย (CTA)', note: 'ถือหลอดระดับอกฉลากหันกล้อง อีกมือชี้ตะกร้า ยิ้มสดใส' },
    ],
    promptEmphasis: [
